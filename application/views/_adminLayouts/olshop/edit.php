...
<div class="main-wrapper">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12">
			<div class="card">
				<form action="<?= base_url('admin/olshop/update')?>" method="POST" class="js_admin-post-olshop">
					<input type="hidden" name="<?= $csrfName ?>" value="<?= $csrfToken ?>">
					<input type="hidden" name="product_id" value="<?= $dataProduct->id ?>">
					<div class="card-header">
						<h5>Edit Produk Online Shop</h5>
					</div>
					<div class="card-body">
						...
						<div class="form-row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="olshop_product_name" name="olshop_product_name" placeholder="Nama Produk" value="<?= set_value('olshop_product_name') ?: $dataProduct->olshop_product_name ?>">
									<small><?= form_error('olshop_product_name')?></small>
								</div>
								<div class="form-group">
									<label for="olshop_product_price">Harga L-poin</label>
									<input type="number" class="form-control" id="olshop_product_price" name="olshop_product_price" placeholder="Harga L-poin" value="<?= set_value('olshop_product_price') ?: $dataProduct->olshop_product_price ?>">
								...
								<div class="form-group">
									...
									<select name="olshop_product_status" id="olshop_product_status" class="single-select form-control js-input-with-plugin" style="display: none;width: 100%">
										<optgroup label="--Pilih Satatus Produk--">
											<option value="1" <?= $dataProduct->olshop_product_status == true ? "selected" : ""?> >Aktif</option>
											<option value="0" <?= $dataProduct->olshop_product_status == false ? "selected" : ""?> >Non-Aktif</option>
										</optgroup>
									</select>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<img src="<?= $dataProduct->olshop_product_img ? base_url('assets/resources/images/uploads/').$dataProduct->olshop_product_img : "https://via.placeholder.com/200x225.png?text=Preview" ?>" alt="ktp"
									...
									<input type="hidden" name="olshop_product_img" id="olshop_product_img" value="<?= $dataProduct->olshop_product_img?>">
