<div class="page-info">
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Edit Program Simpanan</li>
		</ol>
	</nav>
</div>
<div class="main-wrapper">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12">
			...
			<div class="card">
				<form action="<?= base_url('admin/simpanan/content/update')?>" method="POST" class="js_admin-post-simpanan-content">
					<input type="hidden" name="<?= $csrfName ?>" value="<?= $csrfToken ?>">
					<input type="hidden" name="simpanan_content_id" value="<?= $dataSimpananContent->id ?>">
					<div class="card-header">
						<h5>Edit Program Simpanan</h5>
					</div>
					<div class="card-body">
						...
						<div class="form-row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="simpanan_name" name="simpanan_name" placeholder="Nama Program Simpanan" value="<?= set_value('simpanan_name') ?: $dataSimpananContent->simpanan_name ?>">
									<small class="text-danger"><?= form_error('simpanan_name')?></small>
								</div>
								<div class="form-group">
									<label for="simpanan_minimum_price">Minimal Pembayaran *</label>
									<input type="number" class="form-control" id="simpanan_minimum_price" name="simpanan_minimum_price" placeholder="Rp. 50.000" value="<?= set_value('simpanan_minimum_price') ?: $dataSimpananContent->simpanan_minimum_price ?>">
									<small class="text-danger"><?= form_error('simpanan_minimum_price')?></small>
								</div>
								<div class="form-group">
									<label for="simpanan_maximum_price">Maximal Pembayaran</label>
									<input type="number" class="form-control" id="simpanan_maximum_price" name="simpanan_maximum_price" placeholder="Rp. 50.000" value="<?= set_value('simpanan_maximum_price') ?: $dataSimpananContent->simpanan_maximum_price ?>">
									<small class="text-danger"><?= form_error('simpanan_maximum_price')?></small>
								</div>
								<div class="form-group">
									<label for="simpanan_fixed_price">Harga Pasti</label>
									<input type="number" class="form-control" id="simpanan_fixed_price" name="simpanan_fixed_price" placeholder="Rp 50.000" value="<?= set_value('simpanan_fixed_price') ?: $dataSimpananContent->simpanan_fixed_price ?>">
									<small class="text-danger"><?= form_error('simpanan_fixed_price')?></small>
								</div>
								<div class="form-group">
									<label for="simpanan_duration">Durasi Simpanan*</label>
									<div class="input-group">
										<input type="number" class="form-control js-input-group" id="simpanan_duration" name="simpanan_duration" placeholder="1" value="<?= set_value('simpanan_duration') ?: $dataSimpananContent->simpanan_duration ?>">
								...
								<div class="form-group">
									...
									<select name="simpanan_content_status" id="simpanan_content_status" class="single-select form-control js-input-with-plugin" style="display: none;width: 100%">
										<optgroup label="--Pilih Satatus Program Simpanan--">
											<option value="1" <?= $dataSimpananContent->simpanan_content_status == true ? "selected" : ""?>>Aktif</option>
											<option value="0" <?= $dataSimpananContent->simpanan_content_status == false ? "selected" : ""?>>Non-Aktif</option>
										</optgroup>
									</select>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="input-group">
										<input type="number" class="form-control js-input-group" id="simpanan_balas_jasa_percentage" name="simpanan_balas_jasa_percentage" placeholder="1" value="<?= set_value('simpanan_balas_jasa_percentage') ?: $dataSimpananContent->simpanan_balas_jasa_percentage ?>">
										<div class="input-group-append">
											<span class="input-group-text btn btn-outline-primary" id="inputGroupPrepend">
												<div class="col-sm-1">
													%
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input type="number" class="form-control js-input-group" id="simpanan_balas_jasa_perdays" name="simpanan_balas_jasa_perdays" placeholder="1" value="<?= set_value('simpanan_balas_jasa_perdays') ?: $dataSimpananContent->simpanan_balas_jasa_perdays ?>">
										<div class="input-group-append">
											<span class="input-group-text btn btn-outline-primary" id="inputGroupPrepend">
												<div class="col-sm-1">
													Bulan
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input type="number" class="form-control js-input-group" id="simpanan_lpoint_percentage" name="simpanan_lpoint_percentage" placeholder="1" value="<?= set_value('simpanan_lpoint_percentage') ?: $dataSimpananContent->simpanan_lpoint_percentage ?>">
										<div class="input-group-append">
											<span class="input-group-text btn btn-outline-primary" id="inputGroupPrepend">
												<div class="col-sm-1">
													%
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input type="number" class="form-control js-input-group" id="simpanan_promo_cashback_percentage" name="simpanan_promo_cashback_percentage" placeholder="1" value="<?= set_value('simpanan_promo_cashback_percentage') ?: $dataSimpananContent->simpanan_promo_cashback_percentage ?>">
										<div class="input-group-append">
											<span class="input-group-text btn btn-outline-primary" id="inputGroupPrepend">
												<div class="col-sm-1">
													%
								...
								<div class="form-group">
									...
									<select name="simpanan_is_promo_active" id="simpanan_is_promo_active" class="single-select form-control js-input-with-plugin" style="display: none;width: 100%">
										<optgroup label="--Pilih Status Promo--">
											<option value="0" <?= $dataSimpananContent->simpanan_is_promo_active == false ? "selected" : ""?>>Non-Aktif</option>
											<option value="1" <?= $dataSimpananContent->simpanan_is_promo_active == true ? "selected" : ""?>>Aktif</option>
										</optgroup>
									</select>
								...
								<div class="form-group">
									...
									<select name="simpanan_content_type" id="simpanan_content_type" class="single-select form-control js-input-with-plugin" style="display: none;width: 100%">
										<optgroup label="--Pilih Tipe Program Simpanan--">
											<option value="<?= SimpananContentType::SIMPANAN_KEANGGOTAAN?>" <?= $dataSimpananContent->simpanan_content_type == SimpananContentType::SIMPANAN_KEANGGOTAAN ? "selected" : "" ?>><?= SimpananContentType::SIMPANAN_KEANGGOTAAN?></option>
											<option value="<?= SimpananContentType::SIMPANAN_FUNDING?>" <?= $dataSimpananContent->simpanan_content_type == SimpananContentType::SIMPANAN_FUNDING ? "selected" : "" ?>><?= SimpananContentType::SIMPANAN_FUNDING?></option>
										</optgroup>
									</select>
