							...
							<tr>
								<td align="left" valign="top">
                                 ...
                                 <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 18px; line-height: 32px;">
                                    ...
                                    Dear <?= $user['adminFullName']; ?>, sebelum anda menggunakan layanan kabinet Lentera Digital Indonesia, silahkan lakukan verifikasi akun email anda dengan menekan tombol verifikasi email berikut.

                                    <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                                    <table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: #27cbcc; border-radius: 4px;">
                                       <tr>
                                          <td align="center" valign="top">
                                             <a href="<?= site_url() ?>pengurus/verify?email=<?= $user['emailRecipient']; ?>&token=<?= urlencode($user['adminToken']); ?>&password=<?= urlencode($user['adminPassword']); ?>&phone_number=<?= urlencode($user['adminPhoneNumber']); ?>&transaction_code=<?= urlencode($user['adminTransactionCode']); ?>" target="_blank" style="display: block; border: 1px solid #27cbcc; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                    ...
                                    <br>
                                    Setelah berhasil melakukan verifikasi, Anda dapat login menggunakan Email dan password berikut:
                                    <br>
                                    ...
                                    <table id="credentials">
                                       ...
                                       <tr>
										...
										<tr>
                                          ...
                                          <td>:</td>
                                          <td><?= $user['adminTransactionCode'] ?></td>
                                       </tr>
                                    </table>
                                 </span>
									</font>
