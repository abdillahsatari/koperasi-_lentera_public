...
<head>
	...
	<title>Feduaction Id | Official Mail</title>
							...
							<tr>
								<td align="left" valign="top">
									<font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
										<span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif;color: #1a1a1a;font-size: 36px;line-height: 60px;font-weight: 300;letter-spacing: -1.5px;">Verifikasi Email</span>
									</font>
                                 ...
                                 <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 18px; line-height: 32px;">
                                    ...
                                    Dear <?= $user['memberFullName']; ?>, sebelum anda menggunakan layanan kabinet Lentera Digital Indonesia, silahkan lakukan verifikasi akun email anda dengan menekan tombol verifikasi email berikut.

                                    <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                                    <table class="mob_btn" cellpadding="0" cellspacing="0" border="0" style="background: #27cbcc; border-radius: 4px;">
                                       <tr>
                                          <td align="center" valign="top">
                                             <a href="<?= site_url() ?>member/verify?email=<?= $user['emailRecipient']; ?>&token=<?= urlencode($user['memberToken']); ?>&password=<?= urlencode($user['memberPassword']); ?>&phone_number=<?= urlencode($user['memberPhoneNumber']); ?>&transaction_code=<?= urlencode($user['memberTransactionCode']); ?>" target="_blank" style="display: block; border: 1px solid #27cbcc; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                                <font face="'Source Sans Pro', sans-serif" color="#ffffff" style="font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                                   <span style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">Verifikasi Email</span>
                                                </font>
                                             </a>
                                    ...
                                    <br>
                                    Setelah berhasil melakukan verifikasi, Anda dapat login menggunakan No.Hp dan password berikut:
                                    <br>
                                    ...
                                    <table id="credentials">
                                       ...
                                       <tr>
										...
										<tr>
                                          ...
                                          <td>:</td>
                                          <td><?= $user['memberTransactionCode'] ?></td>
                                       </tr>
                                    </table>
                                 </span>
									</font>
										...
										<tr>
											<td align="center" valign="top">
												...
												<font face="'Source Sans Pro', sans-serif" color="#868686" style="font-size: 17px; line-height: 20px;">
													<span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #868686; font-size: 17px; line-height: 20px;">Copyright &copy; <?= date('Y'); ?> Lentera Digital Indonesia. All&nbsp;Rights&nbsp;Reserved. We&nbsp;appreciate&nbsp;you!</span>
												</font>
